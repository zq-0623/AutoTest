...
# 用例模板路径
model_path = f'../testCase/InterfaceCompare/compare.json'
# 新生成的用例yaml路径
new_path = f'../testCase/InterfaceCompare/compare.yaml'
# # 报告名称
# name = "接口自动化测试报告"
...
if __name__ == '__main__':
    ...
    os.system(f'pytest -m {runType} -n {num} --alluredir  ./result/  --clean-alluredir')  # 生成测试结果
    # 添加环境参数
    os.system('copy  ..\\environment.properties  result\\environment.properties')
    os.system(f'allure generate ./result/ -o ./report/{time1}/')  # 生成测试报告
